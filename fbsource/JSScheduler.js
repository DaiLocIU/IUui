__d("JSScheduler", ["SchedulerFb-Internals_DO_NOT_USE"], (function(t, n, r, o, a, i) {
    "use strict";
    var e, l = {
        unstable_Idle: (e = n("SchedulerFb-Internals_DO_NOT_USE")).unstable_IdlePriority,
    ...
    }, s = !1, u = e.unstable_scheduleCallback, c = e.unstable_cancelCallback, d = {
        ...
        deferUserBlockingRunAtCurrentPri_DO_NOT_USE: function(t) {
            ...
            return u(l.unstable_UserBlocking, function() {
                n("SchedulerFb-Internals_DO_NOT_USE").unstable_runWithPriority(e, t)
            })
        },
        ...
        makeSchedulerGlobalEntry: function(r, o, a) {
            ...
            o === void 0 && (o = !1),
            a === void 0 && (a = !1),
            r != null && n("SchedulerFb-Internals_DO_NOT_USE").unstable_forceFrameRate(r),
            o && d.startEventProfiling(),
            a !== !0 && (t.ScheduleJSWork = function(e) {
                return function() {
                    for (var t = arguments.length, n = new Array(t), r = 0; r < t; r++)
                        n[r] = arguments[r];
                    s ? e.apply(void 0, n) : d.deferUserBlockingRunAtCurrentPri_DO_NOT_USE(function() {
                        s = !0;
                        try {
                            e.apply(void 0, n)
                        } finally {
        ...
        startEventProfiling: function() {
            var e, t = (e = n("SchedulerFb-Internals_DO_NOT_USE").unstable_Profiling) == null ? void 0 : e.startLoggingProfilingEvents;
            typeof t == "function" && t()
        },
        stopEventProfiling: function() {
            var e, t = (e = n("SchedulerFb-Internals_DO_NOT_USE").unstable_Profiling) == null ? void 0 : e.stopLoggingProfilingEvents;
