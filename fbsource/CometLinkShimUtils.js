__d("CometLinkShimUtils", ["CometClickIDParameterUtils", "CometLynxGeneration", "ConstUriUtils", "LinkshimHandlerConfig", "Random", "gkx", "isLinkshimURI", "isRelativeURL", "isTrustedDestination", "justknobx"], (function(t, n, r, o, a, i, l) {
    "use strict";
    function e(e) {
        if (!r("LinkshimHandlerConfig").is_linkshim_supported || r("isRelativeURL")(e.toString()))
            return !1;
        var t = e.getProtocol();
        if (r("justknobx")._("3409")) {
            if (t !== "http" && t !== "https" && t !== "tel")
                return !1
    ...
    function m(t, n, a, i, l, s, m, p) {
        ...
        if (D != null && (_ = D),
        e(_) && s !== !0 && !f) {
            var x = o("CometLynxGeneration").getShimmedHref(_, g, {
                callbacks: n,
                trackingNodes: a
            }, m)
            ...
            return $ ? {
                ...
                href: x.toString(),
                shimmed: !0,
                unshimmedHref: m === !0 ? _.toStringPreserveQuery() : _.toString()
            }
        } else
            return {
                clickIDAppended: R,
