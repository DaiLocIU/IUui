__d("SchedulerFb-Internals_DO_NOT_USE", ["Scheduler-dev.classic", "Scheduler-profiling.classic", "ifRequireable", "requestAnimationFramePolyfill"], (function(t, n, r, o, a, i) {
    "use strict";
    t.requestAnimationFrame === void 0 && (t.requestAnimationFrame = n("requestAnimationFramePolyfill"));
    var e;
    ...
    a.exports = {
        ...
        unstable_scheduleCallback: function(r, o, a) {
            var t = n("ifRequireable")("TimeSlice", function(e) {
