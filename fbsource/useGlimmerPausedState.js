__d("useGlimmerPausedState", ["react", "react-compiler-runtime", "usePartialViewImpression"], (function(t, n, r, o, a, i, l) {
    "use strict";
    var e, s = e || (e = o("react")), u = s.useCallback, c = s.useState;
    function d(e) {
        var t = o("react-compiler-runtime").c(6), n = e === void 0 ? !0 : e, a = c(n), i = a[0], l = a[1], s;
        ...
        t[2] = p) : p = t[2];
        var _ = r("usePartialViewImpression")(p), f;
        return t[3] !== _ || t[4] !== i ? (f = {
            paused: i,
            ref: _
        },
        t[3] = _,
